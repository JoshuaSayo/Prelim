...
<script>
$(function(){
  $("#head-placeholder").load("includes/head.php");
});
</script>
<!--end of head-->
...
<nav id="toc" class="fixedsidebar d-none d-lg-block">   
    <h5 class="mt-4 mb-4 pt-1"><a class="text-dark navbar-brand" href="./index.php"><strong>Mundana</strong> Theme</a></h5>
...
<!----------------------------------------------------------------------
NAVBAR (Different Nav bar!)
------------------------------------------------------------------------>
<nav class="topnav navbar navbar-expand-lg navbar-light bg-white fixed-top">
<div class="container">
	<a class="navbar-brand d-lg-none" href="./index.php"><i class="fas fa-anchor mr-2"></i><strong>Mundana</strong></a>
	...
	<div class="navbar-collapse collapse" id="navbarColor02">
		<ul class="navbar-nav mr-auto d-flex align-items-center">
			<li class="nav-item">
			<a class="nav-link" href="./index.php">&larr; Back to demo</a>
			</li>
		</ul>
...
<p class="lead">Hey there! You’re looking at <a href="./index.php">Mundana</a> official documentation. Mundana is an HTML blogging template with flexible, ready to use UI components which will hep you build your blog faster. Let’s begin!
</p>
...
<div class="container text-center">
	...
	<div class="d-flex">
		<div class="col">
			<a href="./article.php"><img src="assets/img/screenshot-mundana-article.png" class="shadow-lg"></a>
		</div>
		<div class="col">
			<a href="./index.php"><img src="assets/img/screenshot-mundana.png" class="shadow-lg"></a>
		</div>
		<div class="col">
			<a href="./category.php"><img src="assets/img/screenshot-mundana-category.png" class="shadow-lg"></a>
		</div>
	</div>
</div>
</section>
