...
?>
<title>
    Board Member List | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Board Member List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Board Member List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover responsive nowrap" style="width: 100%;"
                                ...
                                <tbody>
                                    <?php
                                    $listBoard = mysqli_query($db, "SELECT *, CONCAT(tbl_board.board_lastname, ', ', tbl_board.board_firstname, ' ', tbl_board.board_middlename) AS fullname FROM tbl_board");
                                    while ($row = mysqli_fetch_array($listBoard)) {
                                        $id = $row['board_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_lastname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_firstname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_middlename']; ?></td>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.board.php?board_id=<?php echo $id; ?>"><i
                                        ...
                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.board.php?board_id=<?php echo $id; ?>"
